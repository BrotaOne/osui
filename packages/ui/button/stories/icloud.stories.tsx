...
export const Demo = () => {
    ...
    return (
        <div id="imagediff-button1">
            ...
            <p>普通样式</p>
            <Flex>
                <Button type="default" style={style}>普通样式</Button>
                <Button type="default" disabled style={style}>普通样式</Button>
                <Button type="default" loading style={style}>普通样式</Button>
            </Flex>
            <p>加强样式</p>
            <Flex>
                <Button type="strong" style={style}>加强样式</Button>
                <Button type="strong" disabled style={style}>加强样式</Button>
                <Button type="strong" loading style={style}>加强样式</Button>
            </Flex>
            <p>重要样式</p>
            <Flex>
                <Button type="primary" style={style}>重要样式</Button>
                <Button type="primary" disabled style={style}>重要样式</Button>
                <Button type="primary" loading style={style}>重要样式</Button>
            </Flex>
            <h3><b>2、纯文字按钮</b></h3>
            <Blockquote>
            ...
            <p>普通样式</p>
            <Flex>
                <Button type="text" style={style}>文字按钮</Button>
                <Button type="text" disabled style={style}>文字按钮</Button>
                <Button type="text" loading style={style}>文字按钮</Button>
            </Flex>
            <p>加强样式</p>
            <Flex>
                <Button type="link" style={style}>文字按钮</Button>
                <Button type="link" disabled style={style}>文字按钮</Button>
                <Button type="link" loading style={style}>文字按钮</Button>
            </Flex>
            ...
            <p>按钮形式普通样式</p>
            <Button flexCenter icon={<IconHomeOutlined />} style={style}>
                图文按钮
            </Button>
            <Button flexCenter disabled icon={<IconHomeOutlined />} style={style}>
                图文按钮
            </Button>
            <Button flexCenter loading icon={<IconHomeOutlined />} style={style}>
                图文按钮
            </Button>
            <p>按钮形式重要样式</p>
            <Button flexCenter type="primary" icon={<IconHomeOutlined />} style={style}>
                图文按钮
            </Button>
            <Button
                flexCenter
            ...
            <p>普通样式</p>
            <div>
                <Button icon={<IconHomeOutlined />} style={style} />
                <Button disabled icon={<IconHomeOutlined />} style={style} />
                <Button loading icon={<IconHomeOutlined />} style={style} />
            </div>
            <p>加强样式</p>
            <div>
                <Button type="strong" icon={<IconHomeOutlined />} style={style} />
                <Button type="strong" disabled icon={<IconHomeOutlined />} style={style} />
                <Button type="strong" loading icon={<IconHomeOutlined />} style={style} />
            </div>
            <p>重要样式</p>
            <div>
                <Button type="primary" icon={<IconHomeOutlined />} style={style} />
                <Button type="primary" disabled icon={<IconHomeOutlined />} style={style} />
                <Button type="primary" loading icon={<IconHomeOutlined />} style={style} />
            </div>
            <p>纯图标按钮</p>
            <div>
                <Button type="icon" icon={<IconHomeOutlined />} style={style} />
                <Button type="icon" disabled icon={<IconHomeOutlined />} style={style} />
                <Button type="icon" loading icon={<IconHomeOutlined />} style={style} />
            </div>
            <p>纯图标按钮加强</p>
